...
int main(){
	int opc;
	char nameFile[50], nameTableFile[50], nameCompressFile[50]; 
...
void decode(char nameCompressFile[], char  nameTableFile[]){
	FILE *file, *fp;
 	int character, i = 0, tam = 0, j = 0, b = 0;
